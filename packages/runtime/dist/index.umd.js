(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@au-test/kernel')) :
    typeof define === 'function' && define.amd ? define(['exports', '@au-test/kernel'], factory) :
    ...
    class Signaler {
        ...
        dispatchSignal(name, flags) {
            ...
            for (const listener of listeners.keys()) {
                listener.handleChange(undefined, undefined, flags | exports.BindingFlags.updateTargetInstance);
            }
        }
    ...
    */
    ...
    exports.Binding = class Binding {
        ...
        updateTarget(value, flags) {
            this.targetObserver.setValue(value, flags | exports.BindingFlags.updateTargetInstance);
        }
        updateSource(value, flags) {
            this.sourceExpression.assign(flags | exports.BindingFlags.updateSourceExpression, this.$scope, this.locator, value);
        }
        ...
        getAccessor(obj, propertyName) {
            if (DOM.isNodeInstance(obj)) {
                ...
                if (propertyName === 'textContent') {
                    return new exports.ElementPropertyAccessor(this.changeSet, obj, propertyName);
                }
    ...
    class Call {
        ...
        callSource(args) {
            ...
            const result = this.sourceExpression.evaluate(exports.BindingFlags.mustEvaluate, this.$scope, this.locator);
    ...
    function bind(flags) {
        ...
        if (behavior.hasBinding) {
            this.binding(flags | exports.BindingFlags.fromBind);
        }
        const scope = this.$scope;
    ...
    function unbind(flags) {
        if (this.$isBound) {
            ...
            if (behavior.hasUnbinding) {
                this.unbinding(flags | exports.BindingFlags.fromUnbind);
            }
            const bindables = this.$bindables;
    ...
    class Renderer {
        ...
        ["a" /* textBinding */](renderable, target, instruction) {
            ...
            if (expr.isMulti) {
                renderable.$bindables.push(new MultiInterpolationBinding(this.observerLocator, expr, next, 'textContent', exports.BindingMode.toView, this.context));
            }
            else {
                renderable.$bindables.push(new InterpolationBinding(expr.firstExpression, expr, next, 'textContent', exports.BindingMode.toView, this.observerLocator, this.context, true));
            }
        }
        ["b" /* interpolation */](renderable, target, instruction) {
            ...
            const expr = (srcOrExpr.$kind ? srcOrExpr : this.parser.parse(srcOrExpr, 2048 /* Interpolation */));
            if (expr.isMulti) {
                renderable.$bindables.push(new MultiInterpolationBinding(this.observerLocator, expr, target, instruction.dest, exports.BindingMode.toView, this.context));
            }
            else {
                renderable.$bindables.push(new InterpolationBinding(expr.firstExpression, expr, target, instruction.dest, exports.BindingMode.toView, this.observerLocator, this.context, true));
            }
        }
        ["c" /* propertyBinding */](renderable, target, instruction) {
            const srcOrExpr = instruction.srcOrExpr;
            renderable.$bindables.push(new exports.Binding(srcOrExpr.$kind ? srcOrExpr : this.parser.parse(srcOrExpr, 48 /* IsPropertyCommand */ | instruction.mode), target, instruction.dest, instruction.mode, this.observerLocator, this.context));
        }
        ["d" /* iteratorBinding */](renderable, target, instruction) {
            const srcOrExpr = instruction.srcOrExpr;
            renderable.$bindables.push(new exports.Binding(srcOrExpr.$kind ? srcOrExpr : this.parser.parse(srcOrExpr, 539 /* ForCommand */), target, instruction.dest, exports.BindingMode.toView, this.observerLocator, this.context));
        }
        ...
        ["h" /* stylePropertyBinding */](renderable, target, instruction) {
            const srcOrExpr = instruction.srcOrExpr;
            renderable.$bindables.push(new exports.Binding(srcOrExpr.$kind ? srcOrExpr : this.parser.parse(srcOrExpr, 48 /* IsPropertyCommand */ | exports.BindingMode.toView), target.style, instruction.dest, exports.BindingMode.toView, this.observerLocator, this.context));
        }
    ...
    exports.RenderingEngine = __decorate([
        kernel.inject(kernel.IContainer, IChangeSet, IObserverLocator, IEventManager, IExpressionParser, kernel.all(ITemplateCompiler))
        /*@internal*/
    ], exports.RenderingEngine);
    /*@internal*/
    ...
    class DetachLifecycleController {
        ...
        processRemoveNodes() {
            ...
            if (this.flags & exports.LifecycleFlags.unbindAfterDetached) {
            ...
            if (this.flags & exports.LifecycleFlags.unbindAfterDetached) {
                ...
                while (currentRemoveNodes) {
                    if (isUnbindable(currentRemoveNodes)) {
                        currentRemoveNodes.$unbind(exports.BindingFlags.fromUnbind);
                    }
                    nextRemoveNodes = currentRemoveNodes.$nextRemoveNodes;
                    currentRemoveNodes.$nextRemoveNodes = null;
                    currentRemoveNodes = nextRemoveNodes;
    ...
    class CompositionCoordinator {
        ...
        swap(view) {
            ...
            swapTask.addTask(this.detachAndUnbindCurrentView(this.isAttached
                ? exports.LifecycleFlags.none
                : exports.LifecycleFlags.noTasks));
        ...
        detachAndUnbindCurrentView(detachFlags) {
            ...
            return Lifecycle.beginDetach(detachFlags | exports.LifecycleFlags.unbindAfterDetached)
        ...
        bindAndAttachCurrentView() {
            ...
            if (this.isBound) {
                this.currentView.$bind(exports.BindingFlags.fromBindableHandler, this.scope);
            }
            if (this.isAttached) {
                return Lifecycle.beginAttach(this.encapsulationSource, exports.LifecycleFlags.none)
    ...
    const batchedChangesFlags = exports.BindingFlags.fromFlushChanges | exports.BindingFlags.fromBind;
    exports.Repeat = class Repeat {
        ...
        itemsChanged(newValue, oldValue, flags) {
            this.checkCollectionObserver();
            this.processViews(null, flags | exports.BindingFlags.updateTargetInstance);
        }
        // called by a CollectionObserver (async)
        handleBatchedChange(indexMap) {
            this.processViews(indexMap, exports.BindingFlags.fromFlushChanges | exports.BindingFlags.updateTargetInstance);
        }
        ...
        processViews(indexMap, flags) {
            ...
            if (this.$isBound) {
                ...
                if (oldLength < newLength) {
                    ...
                    const lifecycle = Lifecycle.beginDetach(exports.LifecycleFlags.unbindAfterDetached);
            ...
            if (this.$isAttached) {
                const { location } = this;
                const lifecycle = Lifecycle.beginAttach(this.encapsulationSource, exports.LifecycleFlags.none);
                if (indexMap === null) {
                    for (let i = 0, ii = views.length; i < ii; ++i) {
                        const view = views[i];
                        view.mount(location);
    ...
    exports.Repeat = __decorate([
        kernel.inject(IChangeSet, IRenderLocation, IRenderable, IViewFactory),
    ...
    class Aurelia {
        ...
        app(config) {
            ...
            const startTask = () => {
                ...
                Lifecycle.beginAttach(config.host, exports.LifecycleFlags.none)
                    .attach(component)
                    .end();
            };
            this.startTasks.push(startTask);
            this.stopTasks.push(() => {
                const task = Lifecycle.beginDetach(exports.LifecycleFlags.noTasks)
                    .detach(component)
                    .end();
