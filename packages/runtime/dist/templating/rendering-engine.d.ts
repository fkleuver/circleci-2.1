import { IContainer, Immutable } from '@au-test/kernel';
...
export declare const IRenderingEngine: import("@au-test/kernel/dist/di").InterfaceSymbol<IRenderingEngine>;
export declare class RenderingEngine implements IRenderingEngine {
    ...
    getElementTemplate(definition: TemplateDefinition, componentType?: ICustomElementType): ITemplate;
    getViewFactory(definition: Immutable<ITemplateSource>, parentContext?: IRenderContext): IViewFactory;
