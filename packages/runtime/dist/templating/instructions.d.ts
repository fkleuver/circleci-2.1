...
export declare type TemplateDefinition = ResourceDescription<ITemplateSource>;
export declare type TemplatePartDefinitions = Record<string, Immutable<ITemplateSource>>;
export declare type BindableDefinitions = Record<string, Immutable<IBindableDescription>>;
export declare const ITargetedInstruction: import("@au-test/kernel/dist/di").IDefaultableInterfaceSymbol<ITargetedInstruction>;
