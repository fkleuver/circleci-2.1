(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@au-test/kernel'), require('@au-test/runtime')) :
  typeof define === 'function' && define.amd ? define(['exports', '@au-test/kernel', '@au-test/runtime'], factory) :
  ...
  ***************************************************************************** */
  ...
  exports.OneTimeBindingCommand = class OneTimeBindingCommand {
      ...
      compile($symbol) {
          return new OneTimeBindingInstruction(this.parser.parse($symbol.rawValue, 49 /* OneTimeCommand */), $symbol.dest);
      }
  };
  ...
  exports.ToViewBindingCommand = class ToViewBindingCommand {
      ...
      compile($symbol) {
          return new ToViewBindingInstruction(this.parser.parse($symbol.rawValue, 50 /* ToViewCommand */), $symbol.dest);
      }
  };
  ...
  exports.FromViewBindingCommand = class FromViewBindingCommand {
      ...
      compile($symbol) {
          return new FromViewBindingInstruction(this.parser.parse($symbol.rawValue, 51 /* FromViewCommand */), $symbol.dest);
      }
  };
  ...
  exports.TwoWayBindingCommand = class TwoWayBindingCommand {
      ...
      compile($symbol) {
          return new TwoWayBindingInstruction(this.parser.parse($symbol.rawValue, 52 /* TwoWayCommand */), $symbol.dest);
      }
  };
  ...
  exports.TriggerBindingCommand = class TriggerBindingCommand {
      ...
      compile($symbol) {
          return new TriggerBindingInstruction(this.parser.parse($symbol.rawValue, 86 /* TriggerCommand */), $symbol.dest);
      }
  };
  ...
  exports.DelegateBindingCommand = class DelegateBindingCommand {
      ...
      compile($symbol) {
          return new DelegateBindingInstruction(this.parser.parse($symbol.rawValue, 88 /* DelegateCommand */), $symbol.dest);
      }
  };
  ...
  exports.CaptureBindingCommand = class CaptureBindingCommand {
      ...
      compile($symbol) {
          return new CaptureBindingInstruction(this.parser.parse($symbol.rawValue, 87 /* CaptureCommand */), $symbol.dest);
      }
  };
  ...
  exports.CallBindingCommand = class CallBindingCommand {
      ...
      compile($symbol) {
          return new CallBindingInstruction(this.parser.parse($symbol.rawValue, 153 /* CallCommand */), $symbol.dest);
      }
  };
  ...
  class ElementSymbol {
      ...
      lift(instruction) {
          const template = instruction.src.templateOrNode = runtime.DOM.createTemplate();
          const node = this.node;
          if (this.isTemplate) {
  ...
  exports.TemplateCompiler = class TemplateCompiler {
      ...
      compileLetElement($el) {
          ...
          for (let i = 0, ii = attributes.length; ii > i; ++i) {
              const $attr = attributes[i];
              const dest = kernel.PLATFORM.camelCase($attr.dest);
