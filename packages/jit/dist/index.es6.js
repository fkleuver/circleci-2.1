...
class ElementSymbol {
    ...
    lift(instruction) {
        const template = instruction.src.templateOrNode = DOM.createTemplate();
        const node = this.node;
        if (this.isTemplate) {
